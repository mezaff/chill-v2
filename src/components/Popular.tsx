...
import { useFetchPopularMovies } from "@/services/useFetchPopularMovies";
...
const Popular = () => {
  const { popularMovies, popularMoviesError } = useFetchPopularMovies();
                  ...
                  {hoveredId === movie.id && (
                    <div className="flex flex-col gap-2 items-center justify-center md:justify-between w-[95px] h-[145px] md:w-[234px] md:h-[365px] md:py-15 md:px-5">
                      ...
                      <Button
                        ...
                        className="rounded-full bg-[#3254FF] border-2 border-[#3254FF] text-white hover:bg-transparent hover:text-white mx-10"
                      >
                        Add to List
                      </Button>
                    </div>
